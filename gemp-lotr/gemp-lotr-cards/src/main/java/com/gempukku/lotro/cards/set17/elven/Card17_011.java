...
public class Card17_011 extends AbstractCompanion {
    public Card17_011() {
        super(2, 6, 3, 6, Culture.ELVEN, Race.ELF, null, "Orophin", "Silvan Elf", true);
        addKeyword(Keyword.HUNTER, 1);
    }

    @Override
    public List<? extends Modifier> getInPlayModifiers(LotroGame game, PhysicalCard self) {
return Collections.singletonList(new StrengthModifier(self, self, new SpotCondition(self, Filters.inSkirmishAgainst(CardType.MINION, Filters.wounded)), 3));
}
