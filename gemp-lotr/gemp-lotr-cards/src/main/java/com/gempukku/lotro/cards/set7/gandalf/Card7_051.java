...
public class Card7_051 extends AbstractEvent {
    ...
    @Override
    public PlayEventAction getPlayCardAction(final String playerId, LotroGame game, final PhysicalCard self, final int twilightModifier, boolean ignoreRoamingPenalty) {
