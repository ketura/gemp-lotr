 ...
 */
public class Card40_135 extends AbstractMinion {
    public Card40_135() {
    ...
    public List<? extends ActivateCardAction> getPhaseActionsInPlay(String playerId, LotroGame game, final PhysicalCard self) {
        ...
        && PlayConditions.canDiscardFromStacked(self, game, playerId, 1, Filters.and(Culture.ISENGARD, CardType.ARTIFACT), Keyword.SPELL)) {
            ...
            action.appendEffect(
                    new PreventableEffect(action,
                            ...
                            GameUtils.getFreePeoplePlayer(game), new PreventableEffect.PreventionCost() {
                        @Override
