 ...
 * Vitality: 2
 * Site: 4
 * Game Text: Maneuver: Remove a threat and spot another [ORC] minion to exert an unbound companion.
 */
public class Card15_102 extends AbstractMinion {
    public Card15_102() {
        super(4, 11, 2, 4, Race.ORC, Culture.ORC, "Black Land Overlord");
    }
