...
public class Card4_100 extends AbstractAttachableFPPossession {
    public Card4_100() {
        super(2, 2, 0, Culture.GANDALF, Keyword.MOUNT, "Shadowfax", true);
    }
    ...
    protected List<? extends Modifier> getNonBasicStatsModifiers(PhysicalCard self) {
        return Collections.singletonList(
                new MayNotBearModifier(self, Filters.hasAttached(self), Filters.keyword(Keyword.HAND_WEAPON)));
    }
    ...
    public List<RequiredTriggerAction> getRequiredAfterTriggers(LotroGame game, EffectResult effectResult, PhysicalCard self) {
        if (PlayConditions.played(game.getGameState(), game.getModifiersQuerying(), effectResult, Filters.sameCard(self))) {
            ...
            action.appendEffect(
                    new DiscardCardsFromPlayEffect(self, Filters.and(Filters.attachedTo(Filters.hasAttached(self)), Filters.keyword(Keyword.HAND_WEAPON))));
