...
public class Card7_365 extends AbstractCompanion {
    public Card7_365() {
        super(3, 7, 3, 6, Culture.ROHAN, Race.MAN, Signet.THÉODEN, "Eomer", "Valiant Warchief", true);
        ...
        if (PlayConditions.canUseFPCardDuringPhase(game, Phase.SKIRMISH, self)
            ...
            action.appendEffect(
                    new AddUntilEndOfPhaseModifierEffect(
                            new StrengthModifier(self, self, null, new CountActiveEvaluator(CardType.COMPANION, Keyword.VALIANT)), Phase.SKIRMISH));
