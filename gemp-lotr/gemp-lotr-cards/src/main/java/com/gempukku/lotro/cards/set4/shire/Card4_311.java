...
import com.gempukku.lotro.logic.effects.RemoveCharacterFromSkirmishEffect;
...
public class Card4_311 extends AbstractCompanion {
    public Card4_311() {
        super(1, 3, 4, 6, Culture.SHIRE, Race.HOBBIT, Signet.GANDALF, "Merry", "Unquenchable Hobbit", true);
    }
