...
public class Card1_281 extends AbstractPermanent {
    public Card1_281() {
        super(Side.SHADOW, 0, CardType.CONDITION, Culture.SAURON, "Under the Watching Eye");
    ...
    public List<? extends AbstractExtraPlayCostModifier> getExtraCostToPlay(LotroGame game, PhysicalCard self) {
        return Collections.singletonList(
                new ExertExtraPlayCostModifier(self, self, null, Culture.SAURON, Keyword.TRACKER));
    }
