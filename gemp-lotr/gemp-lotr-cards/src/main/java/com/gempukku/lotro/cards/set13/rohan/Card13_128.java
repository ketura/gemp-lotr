...
public class Card13_128 extends AbstractCompanion {
    public Card13_128() {
        super(2, 6, 3, 6, Culture.ROHAN, Race.MAN, null, "Hama", "Captain of the King's Guard", true);
    }

    @Override
    public List<? extends Modifier> getInPlayModifiers(LotroGame game, PhysicalCard self) {
return Collections.singletonList(new StrengthModifier(self, self, null, new CountActiveEvaluator(Side.SHADOW, CardType.POSSESSION)));
}
