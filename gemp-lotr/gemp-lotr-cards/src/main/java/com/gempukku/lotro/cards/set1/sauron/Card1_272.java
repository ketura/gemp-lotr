 ...
 * Vitality: 2
 * Site: 6
 * Game Text: Skirmish: Exert this minion to wound a character it is skirmishing.
 */
public class Card1_272 extends AbstractMinion {
    public Card1_272() {
        super(4, 10, 2, 6, Keyword.ORC, Culture.SAURON, "Orc War Band");
    }
