...
public class Card1_018 extends AbstractEvent {
    public Card1_018() {
        super(Side.FREE_PEOPLE, 1, Culture.DWARVEN, "Halls of My Home", Phase.FELLOWSHIP);
    }
                                        ...
                                        new RevealTopCardsOfDrawDeckEffect(self, chosenPlayerId, 3) {
                                            ...
                                            protected void cardsRevealed(final List<PhysicalCard> revealedCards) {
                                                if (revealedCards.size() > 0) {
                                                    Collection<PhysicalCard> shadowCards = Filters.filter(revealedCards, game, Side.SHADOW);
