...
public class Card13_008 extends AbstractPermanent {
    public Card13_008() {
        super(Side.FREE_PEOPLE, 2, CardType.CONDITION, Culture.DWARVEN, Zone.SUPPORT, "Subterranean Homestead", null, true);
    }
    ...
    public PlayPermanentAction getPlayCardAction(String playerId, LotroGame game, PhysicalCard self, int twilightModifier, boolean ignoreRoamingPenalty) {
        ...
        action.appendCost(
                new ChooseAndExertCharactersEffect(action, playerId, 2, 2, Race.DWARF));
        return action;
    }
