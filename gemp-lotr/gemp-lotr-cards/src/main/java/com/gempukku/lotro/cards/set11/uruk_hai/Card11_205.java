...
return Collections.singletonList(new StrengthModifier(self, self, null, new MultiplyEvaluator(2, new CountActiveEvaluator(Culture.URUK_HAI, CardType.MINION, Filters.notAssignedToSkirmish))));
}
}
