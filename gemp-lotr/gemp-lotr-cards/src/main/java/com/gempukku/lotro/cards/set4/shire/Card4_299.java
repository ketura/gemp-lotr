...
public class Card4_299 extends AbstractPermanent {
    public Card4_299() {
        super(Side.FREE_PEOPLE, 0, CardType.CONDITION, Culture.SHIRE, "Cliffs of Emyn Muil", null, true);
    }

    @Override
    public List<RequiredTriggerAction> getRequiredAfterTriggers(LotroGame game, EffectResult effectResult, final PhysicalCard self) {
        if (TriggerConditions.movesFrom(game, effectResult, Filters.siteBlock(SitesBlock.TWO_TOWERS), Filters.siteNumber(1))) {
