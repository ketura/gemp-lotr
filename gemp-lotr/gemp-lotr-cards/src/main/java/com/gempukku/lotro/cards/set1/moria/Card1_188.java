...
public class Card1_188 extends AbstractPermanent {
    public Card1_188() {
        super(Side.SHADOW, 2, CardType.CONDITION, Culture.MORIA, "The Long Dark", null, true);
    }
    ...
    public List<RequiredTriggerAction> getRequiredAfterTriggers(LotroGame game, EffectResult effectResult, PhysicalCard self) {
        if (TriggerConditions.movesTo(game, effectResult, Filters.siteBlock(SitesBlock.FELLOWSHIP), Filters.or(Filters.siteNumber(4), Filters.siteNumber(5)))) {
