...
public class Card2_077 extends AbstractPermanent {
    public Card2_077() {
        super(Side.SHADOW, 2, CardType.CONDITION, Culture.WRAITH, "His Terrible Servants");
    }
    ...
    public List<? extends ActivateCardAction> getOptionalInPlayBeforeActions(String playerId, LotroGame game, Effect effect, PhysicalCard self) {
        if (TriggerConditions.isGettingWounded(effect, game, Race.NAZGUL, Keyword.TWILIGHT)
            ...
            action.appendEffect(
                    new ChooseActiveCardEffect(self, playerId, "Choose twilight Nazgul", Filters.in(woundedCards), Race.NAZGUL, Keyword.TWILIGHT) {
                        @Override
