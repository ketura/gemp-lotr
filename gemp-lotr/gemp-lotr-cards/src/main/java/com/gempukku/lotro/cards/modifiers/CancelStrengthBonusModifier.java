...
public class CancelStrengthBonusModifier extends AbstractModifier {
    ...
    public CancelStrengthBonusModifier(PhysicalCard source, Condition condition, Filter affectFilter) {
        super(source, "Cancel strength bonus", affectFilter, condition, ModifierEffect.STRENGTH_MODIFIER);
    }
