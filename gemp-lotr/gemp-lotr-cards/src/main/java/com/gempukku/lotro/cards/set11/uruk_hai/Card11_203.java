...
return Collections.singletonList(new CantTakeWoundsModifier(self, new SpotCondition(Filters.not(self), Culture.URUK_HAI, CardType.MINION, Filters.assignedToSkirmish), self));
}
}
