...
public class Card15_151 extends AbstractCompanion {
    public Card15_151() {
        super(1, 3, 4, 9, Culture.SHIRE, Race.HOBBIT, null, "Pippin", "The Short One", true);
    }

    @Override
    public List<? extends Modifier> getAlwaysOnModifiers(LotroGame game, PhysicalCard self) {
return Collections.singletonList(new TwilightCostModifier(self, Filters.and(Culture.SHIRE, CardType.FOLLOWER), -1));
}
