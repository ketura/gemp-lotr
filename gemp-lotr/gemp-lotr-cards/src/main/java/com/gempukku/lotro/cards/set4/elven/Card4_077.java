 ...
 * Twilight Cost: 1
 * Type: Condition
 * Game Text: To play, spot 3 Elves. Plays to your support area. Each wounded minion loses all damage bonuses.
 * Discard this condition during the regroup phase.
 */
public class Card4_077 extends AbstractPermanent {
    public Card4_077() {
        super(Side.FREE_PEOPLE, 1, CardType.CONDITION, Culture.ELVEN, Zone.SUPPORT, "Lorien Is Most Welcome");
    }
