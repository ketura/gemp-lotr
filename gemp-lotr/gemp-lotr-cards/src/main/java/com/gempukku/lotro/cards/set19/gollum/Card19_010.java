...
public class Card19_010 extends AbstractMinion {
    public Card19_010() {
        super(2, 5, 4, 3, null, Culture.GOLLUM, "Gollum", "Threatening Guide", true);
    }

    @Override
    public List<? extends Modifier> getInPlayModifiers(LotroGame game, PhysicalCard self) {
return Collections.singletonList(new StrengthModifier(self, self, null, new ForEachThreatEvaluator()));
}
