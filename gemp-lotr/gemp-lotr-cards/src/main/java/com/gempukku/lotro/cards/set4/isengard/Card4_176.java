...
public class Card4_176 extends AbstractMinion {
    ...
    public List<? extends Modifier> getAlwaysOnModifiers(LotroGame game, PhysicalCard self) {
        ...
        modifiers.add(
                new StrengthModifier(self, Filters.sameCard(self), new SpotCondition(2, Filters.and(Culture.ISENGARD, Keyword.TRACKER)), 3));
        modifiers.add(
                new KeywordModifier(self, Filters.sameCard(self), new SpotCondition(3, Filters.and(Culture.ISENGARD, Keyword.TRACKER)), Keyword.DAMAGE, 1));
        return modifiers;
    }
}
