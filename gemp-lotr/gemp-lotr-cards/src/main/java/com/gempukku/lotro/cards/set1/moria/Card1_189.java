...
public class Card1_189 extends AbstractResponseEvent {
    ...
    @Override
    public List<PlayEventAction> getOptionalInHandAfterActions(final String playerId, final LotroGame game, EffectResult effectResult, final PhysicalCard self) {
