...
public class Card15_118 extends AbstractPermanent {
    public Card15_118() {
        super(Side.SHADOW, 1, CardType.CONDITION, Culture.ORC, "Unmistakable Omen", null, true);
    }

    @Override
    public List<? extends Modifier> getInPlayModifiers(LotroGame game, PhysicalCard self) {
return Collections.singletonList(new MinionSiteNumberModifier(self, Filters.and(Culture.ORC, Race.ORC), new MinThreatCondition(1), -1));
}
