...
public class Card1_017 extends AbstractAlly {
    public Card1_017() {
        super(1, SitesBlock.FELLOWSHIP, 3, 3, 3, Race.DWARF, Culture.DWARVEN, "Grimir", "Dwarven Elder", true);
    }
    ...
    protected List<? extends Action> getExtraInPlayPhaseActions(final String playerId, LotroGame game, final PhysicalCard self) {
        if (PlayConditions.canUseFPCardDuringPhase(game, Phase.FELLOWSHIP, self)
            ...
            Collection<PhysicalCard> discardedDwarvenEvents = Filters.filter(game.getGameState().getDiscard(playerId), game, Culture.DWARVEN, CardType.EVENT);
