        ...
        action.appendEffect(
                new ChooseOpponentEffect(playerId) {
                    ...
                    protected void opponentChosen(final String opponentId) {
                        action.appendEffect(
                                new RevealAndChooseCardsFromOpponentHandEffect(action, playerId, opponentId, self, "Choose an ISENGARD minion", Filters.and(Filters.culture(Culture.ISENGARD), CardType.MINION), 0, 1) {
                                    @Override
