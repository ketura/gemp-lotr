...
public class Card_V1_018Tests
{
	...
	public void TheWhiteCouncilStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* Game Text: Skirmish: Exert Gandalf to make a [gandalf] or [elven] companion strength +1 for each [elven] ally you can spot (limit +3).
		* 	While you can spot Saruman, Gandalf is strength -1.
		*/
