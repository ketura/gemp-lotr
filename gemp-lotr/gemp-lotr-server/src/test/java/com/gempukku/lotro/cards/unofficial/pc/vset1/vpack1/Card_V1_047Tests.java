...
public class Card_V1_047Tests
{
	...
	public void ItBetrayedIsildurStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* Type: event
		* Subtype: Regroup
		* Game Text: Discard a [Sauron] orc and spot 5 burdens to choose one of the following effects: make the move limit for this turn -1 or make the free-peoples player to choose to move again (if the move limit allows).
		*/
