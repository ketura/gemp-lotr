...
public class Card_V1_024Tests
{
	...
	public void YouHaveMySwordStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* Subtype: 
		* Strength: 2
		* Game Text: To Play spot Aragorn.
		* 	Plays on a companion with the Aragorn signet (except Aragorn).
		* 	If bearer wins a skirmish you must exert Aragorn or discard this condition.
		*/
