var CardFilter = Class.extend({
    ...
    buildUi: function (elem, pageElem) {
        ...
        this.setSelect = $("<select style='width: 130px; font-size: 80%;'>"
            ...
            + "<option value='1-3,61-73,151'>PLAYTEST - Fellowship Block (PC)</option>"
            + "<option value='1-10,61-80,151'>PLAYTEST - Movie Block (PC)</option>"
            + "<option value='1-19,60-89,151'>PLAYTEST - Expanded (PC)</option>"
