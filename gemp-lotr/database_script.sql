...
PRIMARY KEY (`id`) ,
INDEX `player_collection` (`player_id` ASC, `type` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 36167
...
INDEX `index3` (`winner` ASC) ,
INDEX `index4` (`loser` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 517160
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;

-- -----------------------------------------------------
-- Table `gemp-lotr`.`ip_ban`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gemp-lotr`.`ip_ban` (
`id` INT(11) NOT NULL AUTO_INCREMENT ,
...
ENGINE = InnoDB
AUTO_INCREMENT = 21899
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;

-- -----------------------------------------------------
-- Table `gemp-lotr`.`scheduled_tournament`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gemp-lotr`.`scheduled_tournament` (
`id` INT(11) NOT NULL AUTO_INCREMENT ,
`tournament_id` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
`name` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
`format` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
`start` DECIMAL(20,0) NOT NULL ,
`cost` DECIMAL(10,0) NOT NULL ,
`playoff` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
`prizes` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
`minimum_players` DECIMAL(3,0) NOT NULL ,
`started` DECIMAL(1,0) NOT NULL DEFAULT '0' ,
PRIMARY KEY (`id`) ,
INDEX `started` (`started` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
PRIMARY KEY (`id`) ,
INDEX `player` (`player` ASC, `notify` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 1424795
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
