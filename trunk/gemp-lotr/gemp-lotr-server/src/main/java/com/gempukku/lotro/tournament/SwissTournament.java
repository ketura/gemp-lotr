...
//
//    public SwissTournament(TournamentMatchDAO tournamentMatchDao, Map<String, LotroDeck> players, Set<String>[] droppedPlayers, int roundCount, int status, String id, LotroFormat format) {
