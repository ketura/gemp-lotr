                ...
                new Filter() {
                    ...
                    public boolean accepts(GameState gameState, ModifiersQuerying modifiersQuerying, PhysicalCard physicalCard) {
                        ...
                        return gameState.getTwilightPool() + twilightCost <= 4
                                && physicalCard.getBlueprint().checkPlayRequirements(playerId, _game, physicalCard, 0, false, false);
                    }
                });
    }
        ...
        return new ArbitraryCardsSelectionDecision(1, "Starting fellowship - Choose next character or press DONE",
            ...
            public void decisionMade(String result) throws DecisionResultInvalidException {
                ...
                if (selectedCharacters.size() == 0)
                    ...
                    Action playCardAction = selectedPhysicalCard.getBlueprint().getPlayCardAction(playerId, _game, selectedPhysicalCard, 0, false);
