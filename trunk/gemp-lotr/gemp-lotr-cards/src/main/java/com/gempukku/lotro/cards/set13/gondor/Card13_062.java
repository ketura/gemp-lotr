...
public class Card13_062 extends AbstractCompanion {
    public Card13_062() {
        super(3, 8, 3, 6, Culture.GONDOR, Race.MAN, null, "Boromir", true);
    }

    @Override
    public Modifier getAlwaysOnModifier(PhysicalCard self) {
        return new ResistanceModifier(self, self, null, new NegativeEvaluator(new CountSpottableEvaluator(CardType.MINION, Keyword.LURKER)));
    }
