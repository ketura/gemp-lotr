...
public class Card1_297 extends AbstractAlly {
    public Card1_297() {
        super(1, 1, 2, 2, Culture.SHIRE, "Hobbit Party Guest");
    ...
    protected List<? extends Action> getExtraPhaseActions(String playerId, LotroGame game, PhysicalCard self) {
        if (PlayConditions.canUseFPCardDuringPhase(game.getGameState(), Phase.FELLOWSHIP, self)
            ...
            final CostToEffectAction action = new CostToEffectAction(self, Keyword.FELLOWSHIP, "Exert this ally to heal another Hobbit ally whose home is site 1.");
            action.addCost(
    ...
    public List<? extends Action> getRequiredAfterTriggers(LotroGame game, EffectResult effectResult, PhysicalCard self) {
        if (effectResult.getType() == EffectResult.Type.START_OF_TURN) {
            CostToEffectAction action = new CostToEffectAction(self, null, "Heal this ally");
